      ...
      <Section title="Cards">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Md3Card variant="elevated">
            ...
            <Md3CardContent>
              <div className="h-24 rounded-lg bg-[var(--md3-primaryContainer)] flex items-center justify-center text-[var(--md3-onPrimaryContainer)]">
          ...
          <Md3Card variant="filled">
            ...
            <Md3CardContent>
              <div className="h-24 rounded-lg bg-[var(--md3-secondaryContainer)] flex items-center justify-center text-[var(--md3-onSecondaryContainer)]">
          ...
          <Md3Card variant="outlined">
            ...
            <Md3CardContent>
              <div className="h-24 rounded-lg bg-[var(--md3-tertiaryContainer)] flex items-center justify-center text-[var(--md3-onTertiaryContainer)]">
      ...
      <Section title="List Items">
        <Md3Card variant="outlined">
          <Md3ListItem
            ...
            trailing={<Check className="w-5 h-5 text-[var(--md3-primary)]" />}
          />
          <div className="mx-4 h-px bg-[var(--md3-outlineVariant)]" />
          <Md3ListItem
