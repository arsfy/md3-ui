      ...
      <Md3CardContent className="p-5">
        <div className="flex items-start justify-between">
          <div className="flex flex-col gap-1">
            <span className="text-sm text-[var(--md3-onSurfaceVariant)] tracking-[0.25px]">
              {label}
            </span>
            <span className="text-2xl font-normal text-[var(--md3-onSurface)] tracking-[-0.25px]">
              {value}
            </span>
          </div>
          <div className="h-10 w-10 rounded-xl bg-[var(--md3-primaryContainer)] text-[var(--md3-onPrimaryContainer)] flex items-center justify-center">
            {icon}
          </div>
        </div>
        <div className="mt-3 flex items-center gap-1 text-sm text-[var(--md3-tertiary)]">
  ...
  return (
    <div className="pb-28 lg:pb-8">
      ...
      <div className="px-4 mt-4 grid grid-cols-2 gap-3">
        <StatCard icon={<ShoppingBag className="w-5 h-5" />} label="Total Orders" value="1,284" change="+12.5%" />
        <StatCard icon={<Users className="w-5 h-5" />} label="New Users" value="384" change="+8.2%" />
        <StatCard icon={<CreditCard className="w-5 h-5" />} label="Revenue" value="$48,230" change="+23.1%" />
        <StatCard icon={<BarChart3 className="w-5 h-5" />} label="Conversion" value="3.24%" change="+1.4%" />
      </div>

      {/* Quick actions */}
      <div className="px-4 mt-6">
        <h3 className="text-sm font-medium tracking-[0.1px] text-[var(--md3-onSurface)]">
          Quick Actions
        </h3>
      ...
      <div className="px-4 mt-6">
        ...
        <Md3Card variant="outlined" className="mt-3">
          <Md3ListItem
            ...
            trailing={<Md3Button variant="text" size="small" className="h-8 px-2">Details</Md3Button>}
          />
