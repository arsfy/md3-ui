        ...
        <Md3Card variant="outlined" className="mt-3">
          ...
          <div className="px-4 py-3 flex items-center justify-between min-h-[56px]">
            <div className="flex items-center gap-4">
              ...
              <span className="text-base text-[var(--md3-onSurface)]">Notifications</span>
            </div>
            <Md3Switch checked={notifications} onChange={e => setNotifications(e.target.checked)} />
          </div>
          <div className="mx-4 h-px bg-[var(--md3-outlineVariant)]" />
          <div className="px-4 py-3 flex items-center justify-between min-h-[56px]">
            <div className="flex items-center gap-4">
              <Globe className="w-6 h-6 text-[var(--md3-onSurfaceVariant)]" />
              <span className="text-base text-[var(--md3-onSurface)]">Location Services</span>
            </div>
            <Md3Switch checked={location} onChange={e => setLocation(e.target.checked)} />
          </div>
        </Md3Card>
      </div>
