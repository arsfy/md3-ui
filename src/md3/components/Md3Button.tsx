...
const md3ButtonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all select-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--md3-primary)] disabled:pointer-events-none disabled:opacity-40',
  {
    variants: {
      variant: {
        filled:
          'bg-[var(--md3-primary)] text-[var(--md3-onPrimary)] hover:shadow-md active:shadow-sm',
        tonal:
          'bg-[var(--md3-secondaryContainer)] text-[var(--md3-onSecondaryContainer)] hover:shadow-sm active:shadow-none',
        outlined:
        ...
        text:
          'text-[var(--md3-primary)] bg-transparent hover:bg-[var(--md3-primary)]/5 active:bg-[var(--md3-primary)]/10',
        elevated:
