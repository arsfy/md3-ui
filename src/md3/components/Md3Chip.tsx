...
const md3ChipVariants = cva(
    'inline-flex items-center justify-center gap-1.5 h-8 px-3 text-sm font-medium tracking-wide rounded-lg border cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--md3-primary)] disabled:pointer-events-none disabled:opacity-40',
    {
        variants: {
            variant: {
                assist: 'border border-[var(--md3-outline)] text-[var(--md3-onSurfaceVariant)] bg-transparent hover:bg-[var(--md3-primary)]/5 hover:border-[var(--md3-outline)]',
                filter: 'border border-[var(--md3-surfaceVariant)] text-[var(--md3-onSurfaceVariant)] bg-[var(--md3-surfaceVariant)] hover:bg-[var(--md3-secondaryContainer)] hover:text-[var(--md3-onSecondaryContainer)]',
                input: 'border border-[var(--md3-outline)] text-[var(--md3-onSurfaceVariant)] bg-transparent hover:bg-[var(--md3-primary)]/5',
                suggestion:
        ...
        compoundVariants: [
            {
                variant: 'filter',
                active: true,
                class: 'bg-[var(--md3-secondaryContainer)] text-[var(--md3-onSecondaryContainer)] border-[var(--md3-secondaryContainer)]',
            },
        ],
        defaultVariants: {
            variant: 'assist',
