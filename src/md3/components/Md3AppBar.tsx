    ...
    return (
      <header
        ...
        className={cn(
          ...
          variant === 'medium' && 'pt-6 pb-4 px-4 flex flex-col justify-end shadow-sm min-h-[112px]',
          variant === 'large' && 'pt-7 pb-5 px-4 flex flex-col justify-end shadow-sm min-h-[152px]',
          className,
        )}
        {...props}
      >
...
const Md3AppBarTitle = forwardRef<HTMLHeadingElement, HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h1
      ref={ref}
      className={cn(
        'text-[var(--md3-onSurface)] font-normal tracking-[0px]',
        className,
      )}
      {...props}
    />
...
export { Md3AppBar, Md3AppBarTitle, Md3AppBarLeading, Md3AppBarTrailing }
